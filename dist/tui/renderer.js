...
export class TUIRenderer {
    ...
    render() {
        ...
        // === Draw 3 panels ===
        this.drawPanel(buf, 'orchestrator', 'Orchestrator', panelStartRow, 1, panel1Width, panelHeight, state.activePanel === 'orchestrator', state.orchestratorLog, undefined);
        this.drawSubtasksPanel(buf, panelStartRow, panel1Width + 1, panel2Width, panelHeight, state.activePanel === 'subtasks', state);
        this.drawAgentsPanel(buf, panelStartRow, panel1Width + panel2Width + 1, panel3Width, panelHeight, state.activePanel === 'agents', state);
    ...
    drawPanel(buf, _id, title, startRow, startCol, width, height, active, lines, _selectedIdx) {
    ...
    drawSubtasksPanel(buf, startRow, startCol, width, height, active, state) {
        const borderColor = active ? CYAN : DIM;
    ...
    drawAgentsPanel(buf, startRow, startCol, width, height, active, state) {
        const borderColor = active ? CYAN : DIM;
