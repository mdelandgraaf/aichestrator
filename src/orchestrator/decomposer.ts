...
import { Task, Subtask, AgentType, AgentTypeSchema } from '../config/schema.js';
...
Return the subtasks as JSON.`;
  ...
  private parseDecomposition(text: string): DecompositionResult[] {
  ...
  private async createSubtasks(
    ...
    const idMap = new Map<number, string>(); // index -> subtask ID
